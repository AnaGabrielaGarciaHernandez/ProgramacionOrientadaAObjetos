...
class View:
    ...
    def crear(ventana):
        ...
        txt_descripciona=Entry(ventana,justify="center")
        txt_descripciona.pack(pady=15)

        btn_guardar=Button(ventana,text="Guardar",command=lambda:controlador1.Controlador.crear_nota(id_user,txt_titulo.get(),txt_descripciona.get()))
    ...
    def mostrar(ventana):
        ...
        filas=""
        registros=controlador1.Controlador.mostrar_notas(id_user)
        num_nota=1
        if len(registros)>0:
