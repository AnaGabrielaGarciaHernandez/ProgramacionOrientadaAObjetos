...
coche1.setPlazas(5)
coche1.num_serie="B01234234A" #se puede sin la necesidad de cambiar la clase

#Se le llama multiples objetos ya que se tienen muchos objetos de la misma clase, con diferentes atributos
